...
Looking for Transducers in other Lisps? Check out the [[https://github.com/fosskers/cl-transducers][Common Lisp]] and [[https://github.com/fosskers/transducers.fnl][Fennel]]
implementations!
...
- [[#api][API]]
  ...
  - [[#reducers][Reducers]]
    - [[#t-cons-t-snoc][t-cons, t-snoc]]
    - [[#t-vector][t-vector]]
    - [[#t-string][t-string]]
    - [[#t-hash-table][t-hash-table]]
    - [[#t-count-t-average-t-median-t-quantities][t-count, t-average, t-median, t-quantities]]
...
This library is mostly a port of the [[https://github.com/fosskers/cl-transducers][Common Lisp implementation]], with a few
...
*** t-count, t-average, t-median, t-quantities
...
Count the occurrences of every item in the transduction.
...
#+RESULTS:
: #s(hash-table data (1 4 2 2 3 2 4 2 5 1))
...
lists, those items that passed the check, and those that failed. 
...
#+begin_src emacs-lisp :results verbatim :exports both
(t-transduce (t-map #'1+) (t-for (lambda (n) (message "%s" n))) [1 2 3 4])
#+end_src
